...
const IMAGE_URLS = [
    "https://i.ibb.co/HT0fFmBc/1.jpg", // Картинка 1
    "https://i.ibb.co/3yyFQcVB/2.jpg", // Картинка 2
    "https://i.ibb.co/TMvfGNJ6/3.jpg"  // Картинка 3
];
...
const IMAGE_DESCRIPTIONS = [
    "Семья медведей на берегу",
    "Возня медвежат",
    "Медвежата играют с лодкой"
];
