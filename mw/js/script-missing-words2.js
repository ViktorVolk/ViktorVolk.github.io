...
const wordsData = [
    { id: 'утро', text: 'утро' },
    { id: 'часов', text: 'часов' },
    { id: 'зарядку', text: 'зарядку' },
    { id: 'размяться', text: 'размяться' },
    { id: 'ванную', text: 'ванную' },
    { id: 'холодной', text: 'холодной' },
    { id: 'кухню', text: 'кухню' },
    { id: 'завтрак', text: 'завтрак' },
    { id: 'кашу', text: 'кашу' },
    { id: 'омлет', text: 'омлет' },
    { id: 'чай', text: 'чай' },
    { id: 'школе', text: 'школе' },
    { id: 'девятого', text: 'девятого' },
    { id: 'математика', text: 'математика' },
    { id: 'русский', text: 'русский' }
];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('next-task-btn')?.addEventListener('click', function() {
        window.location.href = 'missing-words-task3.html';
    });
    ...
    function updateProgress() {
        ...
        if (percentage === 100) {
            ...
            progressFill.style.background = 'linear-gradient(90deg, #06D6A0 0%, #2AF7C6 100%)';
        }
    }
