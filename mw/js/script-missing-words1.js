// Данные для задания
const wordsData = [
    { id: 'зоопарк', text: 'зоопарк' },
    { id: 'животных', text: 'животных' },
    { id: 'слон', text: 'слон' },
    { id: 'бананы', text: 'бананы' },
    { id: 'обезьян', text: 'обезьян' },
    { id: 'деревьям', text: 'деревьям' },
    { id: 'интересного', text: 'интересного' },
    { id: 'львы', text: 'львы' },
    { id: 'птицы', text: 'птицы' },
    { id: 'кафе', text: 'кафе' },
    { id: 'сок', text: 'сок' }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('next-task-btn')?.addEventListener('click', function() {
        window.location.href = 'missing-words-task2.html';
    });
    ...
    function updateProgress() {
        ...
        if (percentage === 100) {
            ...
            progressFill.style.background = 'linear-gradient(90deg, #118AB2 0%, #2BA9E0 100%)';
        }
    }
