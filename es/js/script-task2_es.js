// Правильные ответы для задания 2 (номера лишних предложений)
const CORRECT_ANSWERS = [3, 6, 9]; // Номера 9 и 10
let selectedNumbers = [];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('next-task-btn')?.addEventListener('click', function() {
        window.location.href = 'extra-sentence-task3.html';
    });
    ...
    function updateSelectedCount() {
        ...
        if (selectedNumbers.length === 0) {
            selectedCount.style.color = '#4ECDC4';
        } else if (selectedNumbers.length === CORRECT_ANSWERS.length) {
            selectedCount.style.color = '#17a2b8';
        } else {
