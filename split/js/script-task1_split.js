// Данные для задания
const SENTENCES = [
    "Вчера утром я проснулся от яркого солнца.",
    "Мой кот Мурзик уже ждал меня у двери.",
    "Я решил пойти на рыбалку с друзьями.",
    "Мы взяли удочки, наживку и отправились к озеру.",
    "Погода была прекрасная, и мы сразу начали ловить рыбу.",
    "Вечером мы развели костер и пожарили улов.",
    "Кот с нетерпением смотрел на меня, ожидая завтрак.",
    "Я насыпал ему корм и погладил по мягкой шерсти."
];

// Правильное распределение: 1-й текст - предложения 1,2,7,8 (индексы 0,1,6,7)
// 2-й текст - предложения 3,4,5,6 (индексы 2,3,4,5)
const CORRECT_TEXT1 = [1, 2, 7, 8]; // Номера предложений для текста 1
const CORRECT_TEXT2 = [3, 4, 5, 6]; // Номера предложений для текста 2
