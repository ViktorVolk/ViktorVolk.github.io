// Данные для задания
const SENTENCES = [
    "Пушистый комочек с зелёными глазами поселился у нас дома.",
    "После дождя выглянуло солнышко, и на небе появилась радуга.",
    "Она похожа на разноцветный мост из семи красок.",
    "Он обожает гоняться за солнечным зайчиком по стене.",
    "Волшебный мост тянется от одного леса к другому.",
    "Иногда он забирается на диван и сладко мурлычет.",
    "Мы назвали его Барсик.",
    "Хочется верить, что по нему гуляют феи."
];

// Правильное распределение: 1-й текст - предложения 1,2,7,8 (индексы 0,1,6,7)
// 2-й текст - предложения 3,4,5,6 (индексы 2,3,4,5)
const CORRECT_TEXT1 = [1, 4, 6, 7]; // Номера предложений для текста 1
const CORRECT_TEXT2 = [2, 3, 5, 8]; // Номера предложений для текста 2
